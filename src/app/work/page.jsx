        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                containerStyles="absolute flex gap-2 right-0 bottom-60 xl:bottom-0 z-30 w-full justify-between xl:w-max xl:justify-none"
                btnStyles="bg-accent hover:bg-accent-hover text-primary text-[22px] w-[44px] flex justify-center items-center transiton-all"
              />
            </Swiper>
          </div>
        </div>
